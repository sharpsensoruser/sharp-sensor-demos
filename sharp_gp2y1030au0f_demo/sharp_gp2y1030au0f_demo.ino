...
void loop() {  
  ...
  unsigned int PM_A_Count = (unsigned int)PM_A_High * 256 + (unsigned int)PM_A_Low;
  unsigned int PM_B_Count = (unsigned int)PM_B_High * 256 + (unsigned int)PM_B_Low;
  unsigned int PM_C_Count = (unsigned int)PM_C_High * 256 + (unsigned int)PM_C_Low;
